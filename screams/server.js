...
import { audioArrayW, audioArrayM } from './public/scream-sounds.js';
...
io.on('connection', (socket) => {
    ...
    socket.emit('audio', audioArrayM[audio_counter % audioArrayM.length]);
    audio_counter++;

    socket.emit('audio', audioArrayW[audio_counter % audioArrayW.length]);
    audio_counter++;
